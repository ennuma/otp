...
#define CONTEXT_REDS erts_smp_atomic32_read_nob(&erts_sched_context_reds)	/* Swap process out after this number */
#define erts_sched_set_context_reds(reds) erts_smp_atomic32_xchg_nob(&erts_sched_context_reds, reds)
